...
- Delete question selectecd by question_id
- Request Arguments: question_id (required)
- Response Arguments: 
    - `delete_id` (ID of deleted question)
    - dictionary `questions` (10 questions)
    - `total_questions` (the number of all questions)
...
- Request Arguments:
    ...
    - `category`
- Response Arguments:
    - `createdId` (ID of new question)
    - dictionary `questions` (10 questions)
    - `total_questions` (the number of all questions)
    - `current_category` (type of category new quistion)
...
- Response Arguments: 
    - dictionary `questions` (10 questions)
    - dictionary `current_category` (type of category all questions)
    - `total_questions` (the number of all questions)
...
- Response Arguments: 
    - dictionary `questions` get maximum 10 questions
    - `totalQuestions` total question
    - `current_category` type of category
